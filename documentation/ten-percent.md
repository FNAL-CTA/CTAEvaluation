...
The current CTA test database is on server's managed by the Database Services group in ITD. 
...
On the CTA tape node these messages, "tape read successfully", and "file successful read" will be used. 
